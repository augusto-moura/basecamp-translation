...
function c() {
  ...
  }), document.querySelectorAll("#navigation_readings section.readings--memories h3").forEach((e) => {
    e.innerHTML = e.innerHTML.replace("Don’t Forget", n("Don't Forget"));
...
let d = function() {
  s(), document.querySelector(".nav__main").querySelectorAll(".nav__item .nav__link").forEach((e) => {
...
function s() {
  document.querySelector('[data-load-target="#navigation_readings"]').addEventListener("mousedown", (e) => {
    var r = setInterval(() => {
      ...
      ).classList.contains("loading") || (c(), l(400).then(() => {
        c(), clearInterval(r);
      }));
    }, 200);
  });
...
function p() {
  ...
  }), document.querySelectorAll("header p").forEach(
    (e) => a(e, [
  ...
  ), document.querySelectorAll("#home_project_cards").forEach((e) => a(e, ["Recently visited"])), document.querySelectorAll("section.project-index__mystuff").forEach(
    (e) => a(e, [
      "Your Schedule",
...
var _ = chrome.runtime.getURL(`lang/${y}.json`);
(function() {
